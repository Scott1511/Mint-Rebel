function miniConsole() {
    ...
    introMessage.innerText = 'Please enter a Bitcoin wallet address:';
    ...
    inputElement.addEventListener('keydown', function(event) {
      if (event.key === 'Enter') {
        if (!hasEnteredAddress) {
          const isValidAddress = validateAddress(inputElement.value);
          if (isValidAddress) {
            ...
            inputElement.placeholder = 'Invalid address!';
          }
  ...
  function validateAddress(address) {
    ...
    // Check if address is a valid Bitcoin wallet address
